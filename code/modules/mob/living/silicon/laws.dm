...
/mob/living/silicon/proc/deadchat_lawchange()
	...
	deadchat_broadcast("'s laws were changed. <a href='?src=[REF(src)]&printlawtext=[rustg_url_encode(lawtext)]'>View</a>", "<span class='name'>[src]</span>", follow_target=src, message_type=DEADCHAT_LAWCHANGE)
